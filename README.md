...
Configures the service using ES Modules (E SM) and secures credentials via .env file and .gitignore.
...
Uses the hardcoded text from the internal OCR mock.
...
Simulates the full workflow by passing the path to the OCR mock.
